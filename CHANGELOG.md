...
## Unreleased
### Added
* `sql` input `params` for placeholders
...
* array column scalars and filter
* join and set fields
...
## [2.0](https://pypi.org/project/graphique/2.0/) - 2025-10-15
### Changed
* Ibis backend

## [1.9](https://pypi.org/project/graphique/1.9/) - 2025-06-23
### Changed
* Pyarrow >=20 required
